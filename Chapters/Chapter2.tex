...
\lhead{Chapter 1. \emph{Document Similarity}} % This is for the header on each page - perhaps a shortened title
...
\begin{equation}
SIM({t_{1}},{t_{1}}) =\frac{\vec{t_{a}}.\vec{t_{b}}}{|\vec{t_{a}}|\times|\vec{t_{b}}|}
\end{equation}
