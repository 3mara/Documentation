...
\lhead{Chapter 2. \emph{Literature}} % This is for the header on each page - perhaps a shortened title
...
\paragraph{The algorithm}: \citep{literature_2} The key idea of the DBSCAN algorithm is that, for each point of a cluster, the neighbourhood 
