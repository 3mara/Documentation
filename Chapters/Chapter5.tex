...
\section{Mitosis Proposed distance relatedness dynamic model}\label{sec:mitosis_proposed}
...
\section{Algorithms phases}\label{sec:phases}
...
\subsection{Loading associations}
