...
\lhead{Chapter 5. \emph{Recommender Systems}} % This is for the header on each page - perhaps a shortened title
...
\begin{table}[ht]
\caption{A fragmint of a rating matrix for a movie recommender system} % title of Table
\centering  % used for centering table
\begin{tabular}{c c c c c} % centered columns (5 columns)
\hline\hline                        %inserts double horizontal lines
 & K PAX & Life of Brain & Memento & Notorious\\ [0.5ex] % inserts table 
%heading
\hline                  % inserts single horizontal line
Alice & 4 & 3& 2 &4  \\ % inserting body of the table
Bob & $\phi$ & 4 & 5 &5  \\
Cindy & 2 & 2  & 4 &$\phi$  \\
David & 3 & $\phi$& 5 &2 \\[1ex]      % [1ex] adds vertical space
