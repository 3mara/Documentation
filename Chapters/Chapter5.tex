...
\chapter{Used Clustering Technique} % Main chapter title

\label{clustering} % For referencing the chapter elsewhere, use \ref{Chapter4} 

\lhead{Chapter 5. \emph{Used Clustering Technique}} % This is for the header on each page - perhaps a shortened title
