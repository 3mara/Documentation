...
{\huge \bfseries A Proposed Approach for Arabic Semantic Similarity \\ }\\[0.4cm] % Thesis title
...
\begin{minipage}{0.4\textwidth}
\begin{center} \large
Ahmed Mohamed Mohsen \\ Ahmed Mahmoud El-bagoury \\
...
Computer \& System Engineering Department\\[1cm] % Research group name and department name
...
We wish to acknowledge the help provided by our supervisors Porf.Dr.Nagwa El-Makky and Dr.Noha A.
}
\clearpage % Start a new page
